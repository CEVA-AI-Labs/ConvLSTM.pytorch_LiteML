...
import os, sys
root = "/home/olyas/ailabs_conv_lstm"
sys.path.append(os.path.join(root, "ailabs_shared"))
sys.path.append(os.path.join(root, "ailabs_liteml"))
sys.path.append(os.path.join(root, "ailabs_pruning"))
sys.path.append(os.path.join(root, "ailabs_qat"))
