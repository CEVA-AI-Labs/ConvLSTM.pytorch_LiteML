...
class ConvLSTMCell(nn.Module):
    ...
    def __init__(self, input_dim, hidden_dim, kernel_size, bias, padding, stride):
        """
        ...
        self.padding = padding#kernel_size[0] // 2, kernel_size[1] // 2
        self.bias = bias
    ...
    def init_hidden(self, batch_size, image_size):
        ...
        return (torch.zeros(batch_size, self.hidden_dim, height, width, device=self.conv.weight.device if not isinstance(self.conv.weight, Proxy) else 'cpu'),
                torch.zeros(batch_size, self.hidden_dim, height, width, device=self.conv.weight.device if not isinstance(self.conv.weight, Proxy) else 'cpu'))
...
class ConvLSTMBlock(nn.Module):
    ...
    def __init__(self, input_dim, hidden_dim, kernel_size, num_layers,padding, stride,
        ...
        for i in range(0, self.num_layers):
            ...
            cell_list.append(ConvLSTMCell(input_dim=cur_input_dim,
                                          ...
                                          bias=self.bias, padding=padding, stride=stride))
...
class Encoder(nn.Module):
    ...
    def _make_layer(self, type, activation, in_ch, out_ch, kernel_size, padding, stride):
        ...
        if type == 'conv':
            ...
            layers.append(ConvLSTMBlock(in_ch, out_ch, num_layers=1, kernel_size=(kernel_size, kernel_size), padding=padding, stride=stride))
